// ! ORIGINAL FILE: NETLIFY FORM, BUT NO LONGER WORKS WHEN UPGRADED TO NEXT 15
// ! ik WHEN YOU HAVE A DIFFERENT SOLUTION OR NETLIFY FORM WORKS AGAIN, THEN COME BACK TO THIS FILE AS THE ORIGINAL NETLIFY FORM SUBMISSION FILE
"use client";
